...
\begin{align}
    ...
    \vartheta  & = \arctan\left(\frac{2\zeta\lambda}{1-\lambda^2}\right) \approx \siunit{\varthetaVal}{rad} \quad
\end{align}
...
\newpage
\subsection{Végleges mozgástörvény}
\begin{equation}
    \begin{split}
