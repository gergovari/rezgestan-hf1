...
\begin{align}
    ...
    C_2                       & = \sqrt{2 \cdot g \cdot l_3 \cos(30^\circ)} \approx \siunit{\Ctwof}{m/s}
\end{align}

Ezt levetítve az ütközési egyenesre és figyelembe véve hogy a sebességvektor $30^\circ$-ot zár be a vízszintessel illetve balra mutat:
\begin{align}
...
\subsection{Közös ütközés utáni sebesség}
\begin{equation}
    C_{sn} = \frac{m_{T1} \cdot C_{1n} + m_{T2} \cdot C_{2n}}{m_{T1} + m_{T2}} \approx \siunit{\Csn}{m/s}
\end{equation}

\subsection{Az ütközés utáni sebessége a lengőkarnak}
